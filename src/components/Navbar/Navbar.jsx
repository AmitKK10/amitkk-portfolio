    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/AmitKK10"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/amit-kiran-kar-975744277"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-70 backdrop-blur-lg rounded-lg shadow-lg md:hidden">
